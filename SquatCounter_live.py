...
cv2.namedWindow("Squat Counter")
cv2.setMouseCallback("Squat Counter", mouse_callback)
        ...
        if lmList:
            ...
            if angle > 160:  # Standing position
                if direction == 0:
                    ...
                    hold_frames = 0
            elif angle < 90 and direction == 1:  # Squat position
                hold_frames += 1
                if hold_frames >= required_hold:
                    correct_count += 1
                    direction = 0
            ...
            cv2.putText(img, f"Squats: {correct_count}", (50, 100), font, 1, text_color, 2)
