...
cv2.namedWindow("Bicep Curl Counter")
cv2.setMouseCallback("Bicep Curl Counter", mouse_callback)
        ...
        if lmList:
            ...
            if angle > 160:  # Arm extended
                if direction == 0:
                    ...
                    hold_frames = 0
            elif angle < 50 and direction == 1:  # Curl position
                hold_frames += 1
                if hold_frames >= required_hold:
                    correct_count += 1
                    direction = 0
            ...
            cv2.putText(img, f"Curls: {correct_count}", (50, 100), font, 1, text_color, 2)
